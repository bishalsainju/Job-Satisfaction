...
predict_topics <- estimateEffect(formula = 1:10 ~ Ratings + Job_Status, 
...
plot(predict_topics, covariate = "Job_Status", topics = predict_topics$topics,
     model = poliblogPrevFit, method="difference", xlab="Former ............ Current",
...
plot(predict_topics, covariate = "Ratings", topics = predict_topics$topics,
     model = poliblogPrevFit, method="difference", xlab="Lower Rating ............ Higher Rating",
